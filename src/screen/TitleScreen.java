...
public class TitleScreen extends Screen {
  ...
  public TitleScreen(final int width, final int height, final int fps, final Wallet wallet) {
    ...
    // Defaults to play.
    if (!soundManager.isSoundPlaying(Sound.BGM_MAIN)) soundManager.loopSound(Sound.BGM_MAIN);
  ...
  private void nextMenuItem() {
    ...
    */
    if (this.returnCode == 5) this.returnCode = 0;
    else if (this.returnCode == 0) this.returnCode = 6;
    else if (this.returnCode == 6) this.returnCode = 3;
  ...
  private void previousMenuItem() {
    /*
     TODO: Refactor returnCode & Core Logic
    */
    if (this.returnCode == 0) this.returnCode = 5;
    else if (this.returnCode == 6) this.returnCode = 0;
    else if (this.returnCode == 3) this.returnCode = 6;
    else this.returnCode--;
  }
