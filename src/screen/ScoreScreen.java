...
public class ScoreScreen extends Screen {
  ...
  // Set ratios for each coin_lv - placed in an array in the order of lv1, lv2, lv3, lv4, and will
  // be used accordingly,
  ...
  /** Saves the score as a high score. 중복 방지를 위한 로직 추가. */
  ...
  private void draw() {
    ...
    ScoreDrawManager.drawGameOver(this, this.inputDelay.checkFinished(), this.isNewRecord);
    ScoreDrawManager.drawResults(
        this,
        this.score,
        this.playerHp,
        this.shipsDestroyed,
