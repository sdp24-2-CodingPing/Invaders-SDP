...
public class Wallet {
  ...
  // Save the current wallet state to a file. Save format: coin, bullet_lv, shot_lv, lives_lv,
  // coin_lv, each in one line
  ...
  // Create a wallet using the information written in the file. If the file is damaged or
  // unreadable, create it with initial values (0)
