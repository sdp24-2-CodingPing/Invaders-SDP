...
public class SoundManager {
  ...
  private static final Set<Sound> POSITIONAL_SOUNDS =
      Set.of(
          Sound.ALIEN_HIT,
          Sound.ALIEN_LASER,
          Sound.PLAYER_HIT,
          ...
          Sound.ITEM_BOMB,
          Sound.ITEM_SPAWN,
          Sound.ITEM_BARRIER_ON,
          Sound.ITEM_BARRIER_OFF,
          Sound.ITEM_TIMESTOP_ON,
          Sound.ITEM_TIMESTOP_OFF,
          Sound.ITEM_2SHOT,
          Sound.ITEM_3SHOT,
          Sound.ITEM_GHOST,
          Sound.BULLET_BLOCKING);
   ...
   * @throws
   *     IOException,UnsupportedAudioFileException,LineUnavailableException,IllegalArgumentException
   *     exception
   */
  public void loadSound(Sound sound, String filePath)
      throws IOException,
  ...
  public void playSound(Sound sound, float balance) {
    if (soundEnabled) {
      ...
      if (clipPool != null) {
        Clip availableClip =
            clipPool.stream().filter(clip -> !clip.isRunning()).findFirst().orElse(null);
