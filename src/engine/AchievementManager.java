...
public class AchievementManager {
  ...
  public void updatePerfect(final int MAX_LIVES, int checkLives, int gameLevel) {
    if (checkLives >= MAX_LIVES
        && currentPerfectLevel < MAX_PERFECT_STAGE
        && gameLevel > currentPerfectLevel) {
  ...
  public void updatePlaying(int maxCombo, int playtime, int max_lives, int playerHp, int level)
      throws IOException {
